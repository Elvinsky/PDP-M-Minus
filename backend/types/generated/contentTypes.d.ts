...
export interface ApiTestCollectionTypeTestCollectionType
  extends Struct.CollectionTypeSchema {
  collectionName: 'test_collection_types';
  info: {
    displayName: 'TestCollectionType';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    When: Schema.Attribute.DateTime;
  };
}
...
export interface ApiTestSingleTypeTestSingleType
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Mail: Schema.Attribute.Email;
    Nick: Schema.Attribute.Enumeration<['hey', 'hello']>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::test-collection-type.test-collection-type': ApiTestCollectionTypeTestCollectionType;
